...
gStyle.SetOptStat(0)
#c.SetLogx ()
Eprof = TProfile("Eprof", "Ratio of Ecal and Ep;Ep;Ecal/Ep", 50, 100, 300)
num_events=1000
latent = 200
g = generator(latent)
#gweight = 'gen_rootfit_2p1p1_ep33.hdf5'
gweight1 = 'results/INTELONLY/intelonly100-300-30-2/params_generator_epoch_024.hdf5' # 1 gpu
...
#   gweight=gweights[i]                                                                                                                                                                     
   Gprof.append( TProfile("Gprof" +str(i), "Gprof" + str(i), 50, 100, 300))
   #Gprof[i].SetStates(0)
   #Generate events
