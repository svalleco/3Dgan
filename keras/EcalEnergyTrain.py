...
if 'cern.ch' in os.environ.get('HOSTNAME'): # Here a flag for host can be used
    tlab = True
    print('tlab = True')
else:
    tlab= False
...
def get_parser():
    ...
    parser.add_argument('--name', action='store', type=str, default='fixed_angle', help='Identifier for current training')
