...
def main():
   genweight = "thetaweights_concat_2loss_sorted/params_generator_epoch_049.hdf5"
   from EcalCondGan_2loss_concat import generator
   latent = 256
   g=generator(latent)
   ...
   plotsdir = 'angle_plots_gan_concat_2loss'
