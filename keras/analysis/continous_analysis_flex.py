...
#Get VEGAN params
n_jets = 10000         #events to take from data file
latent_space =200
num_events=1000         #events in each bin
save=0                #whether save generated output in a file
get_gen=1             # whether load from file. In that case discrimination will not be performed but the file must be generated using same energies as the data file.
#Get weights
...
plots_dir = 'continous_plots_get_gen/'
## Get Full data                                                               
