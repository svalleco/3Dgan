...
for energy in energies:
   ...
   plot_ecal_normalized(var["Ecal_act" + str(energy)], var["index" + str(energy)], os.path.join(actdir, Ecalfile), fig+10, energy, 'r', 1)
   plot_ecal_normalized(var["Ecal_gan" + str(energy)], var["index" + str(energy)], os.path.join(gendir, Ecalfile), fig+11, energy, 'b', 1)
   plot_ecal_normalized(var["Ecal_act" + str(energy)], var["index" + str(energy)], os.path.join(comdir, Ecalfile), fig+12, energy, 'r')
   plot_ecal_normalized(var["Ecal_gan" + str(energy)], var["index" + str(energy)], os.path.join(comdir, Ecalfile), fig+12, energy, 'b')
