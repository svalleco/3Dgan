...
print ("Starting Testing Generators...",)
sys.stdout.flush()
print ("Start.")
Test_genC.start()
Test_gen1 = Test_genC.first().generate().next()
print ("Done.")
Test_gen = Test_genC.first().generate()
print ('Testing Data')
print ('The data size is ', len(Test_gen1))
print ('Sum of 10 ecal images is', np.sum(Test_gen1[0][:10], axis=(1, 2, 3)))
print ('Corressponding energy is', Test_gen1[1][:10])
