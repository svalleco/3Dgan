...
def main():
   ...
   print('energy for the {} is {} and angle is {}'.format(n, y[n], np.degrees(ang[n])))
   plot_energy_hist(np.expand_dims(x[n], axis=0), outfile + '_1event_log', log=1)
   plot_energy_hist(x, outfile + '_{}event_log'.format(numdata), log=1)
...
def plot_energy_hist(events, out_file, log=0, p=[2, 500], ifpdf=True, stest=True):
