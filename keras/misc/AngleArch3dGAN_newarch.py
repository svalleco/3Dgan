...
def generator2(latent_size=200, return_intermediate=False):
    ...
    loc = Sequential([
        ...
        Conv3D(8, 4, 4, 6, border_mode='valid', init='he_uniform'),
        Activation('relu'),
        BatchNormalization(),
        
        ZeroPadding3D((2, 2, 2)),
        Conv3D(8, 3, 3, 4, border_mode='valid', init='he_uniform'),
        Activation('relu'),
        BatchNormalization(),
        
        Conv3D(8, 2, 2, 3, border_mode='valid', init='he_uniform'),
        Activation('relu'),
