...
def main():
    ...
    from AngleArch3dGAN_dense import generator, discriminator
...
def get_parser():
    ...
    parser.add_argument('--particle', action='store', type=str, default='ChPi', help='Type of particle')
    ...
    parser.add_argument('--name', action='store', type=str, default='gan_training_Ch_pion_dense', help='Unique identifier can be set for each training')
    return parser
