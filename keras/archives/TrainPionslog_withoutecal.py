...
if __name__ == '__main__':
    ...
    Gan3DTrain(d, g, datapath, nEvents, weightdir, pklfile, mod=fitmod, nb_epochs=nb_epochs, batch_size=batch_size, gen_weight=2, aux_weight=0.1, ecal_weight=0.2, xscale = xscale)
