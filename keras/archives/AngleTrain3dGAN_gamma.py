...
def get_parser():
    ...
    parser.add_argument('--nbepochs', action='store', type=int, default=30, help='Number of epochs to train for.')
    ...
    parser.add_argument('--particle', action='store', type=str, default='Gamma', help='Type of particle')
    ...
    parser.add_argument('--prev_gweights', type=str, default='3dgan_weights_gan_training_epsilon_k2/params_generator_epoch_127.hdf5', help='Initial generator weights for warm start')
    parser.add_argument('--prev_dweights', type=str, default='3dgan_weights_gan_training_epsilon_k2/params_discriminator_epoch_127.hdf5', help='Initial discriminator weights for warm start')
    parser.add_argument('--name', action='store', type=str, default='_gamma', help='Unique identifier can be set for each training')
    return parser
