...
def get_parser():
    ...
    parser.add_argument('--weightsdir', action='store', type=str, default='weights/3dgan_weights_bins_pow_p85_aux', help='Directory to store weights.')
    parser.add_argument('--pklfile', action='store', type=str, default='results/3dgan_history_bins_pow_p85_aux.pkl', help='Pickle file to store losses.')
    ...
    parser.add_argument('--lossweights', action='store', type=int, default=[3, 0.05, 25, 0.1, 0.1], help='loss weights =[gen_weight, aux_weight, ang_weight, ecal_weight, add loss weight]')
