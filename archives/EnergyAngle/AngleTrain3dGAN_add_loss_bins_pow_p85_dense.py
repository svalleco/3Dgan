...
def main():
    ...
    if keras.__version__ == '1.2.2':
        from AngleArch3dGAN_add_loss_bins_dense import generator, discriminator
    else:
...
def get_parser():
    ...
    parser.add_argument('--weightsdir', action='store', type=str, default='weights/3dgan_weights_bins_pow_p85_dense', help='Directory to store weights.')
    parser.add_argument('--pklfile', action='store', type=str, default='results/3dgan_history_bins_pow_p85_dense.pkl', help='Pickle file to store losses.')
