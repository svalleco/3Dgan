...
def main():
    ...
    if keras.__version__ == '1.2.2':
        from AngleArch3dGAN_angle_zero_centered import generator, discriminator
    else:
    ...
    pklfile = 'results/3dgan_history_' + params.name # loss history
    resultfile = 'results/3dgan_analysis' + params.name # optimization metric history
...
def get_parser():
    ...
    parser.add_argument('--name', action='store', type=str, default='angle_centered0', help='Identifier for training.')
