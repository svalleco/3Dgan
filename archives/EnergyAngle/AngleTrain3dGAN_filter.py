...
def main():
    ...
    if keras.__version__ == '1.2.2':
        from AngleArch3dGAN_filter import generator, discriminator
    else:
    ...
    resultfile = 'results/3dgan_analysis_' + params.name + '.pkl'# optimization metric history
...
def get_parser():
    ...
    parser.add_argument('--name', action='store', type=str, default='filter', help='Identifier for training.')
    return parser
