...
gStyle.SetOptStat(0)
#c.SetLogx ()
hist_g4 = ROOT.TH2F("g4", "Ratio of Ecal and Ep;Ep;Ecal/Ep", 200, 100, 500, 100, 0, 0.04)
hist_g4.Sumw2()
num_events=1000
latent = 200
g = generator(latent)
...
scales = [100, 1, 1]
filename = 'ecal_ratio_stats_500GeV_50bins.pdf'
#Get Actual Data
...
#   gweight=gweights[i]                                                                                                                                                                     
   hist_gan.append( ROOT.TH2F("Gan" +str(i), "Gan" + str(i), 200, 100, 500, 100, 0, 0.04))
   #Generate events
   ...
   color = color + 2
   chi2 = hist_g4.Chi2Test(hist_gan[i], "UU")
   k = hist_g4.KolmogorovTest(hist_gan[i], "UU")
