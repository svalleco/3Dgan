...
void plot_root_vec()
{
   ...
   // GANs output
   TFile *f = new TFile("results/GANRoot/GAN150GeV.root");
   ...
   //Geant4 full sim
   TFile *f_g4 = new TFile("results/GANRoot/Data150GeV.root");
   TTree *t1_g4 = (TTree*)f_g4->Get("ecalTree2");
   ...
   TH1F *hx   = new TH1F("hx","Ex distribution",51,0,51);
   TH1F *hy   = new TH1F("hy","Ey distribution",51,0,51);
   TH1F *hz   = new TH1F("hz","Ez distribution",25,0,25);
   TH1F *hx_g4   = new TH1F("hx_g4","Ex distribution",51,0,51);
   TH1F *hy_g4   = new TH1F("hy_g4","Ey distribution",51,0,51);
   TH1F *hz_g4   = new TH1F("hz_g4","Ez distribution",25,0,25);
   TH1F *hx_half   = new TH1F("hx_half","Ex distribution",51,0,51);
   TH1F *hy_half   = new TH1F("hy_half","Ey distribution",51,0,51);
   TH1F *hz_half   = new TH1F("hz_half","Ez distribution",25,0,25);
   TH1F *hx_half_g4   = new TH1F("hx_half_g4","Ex distribution",51,0,51);
   TH1F *hy_half_g4   = new TH1F("hy_half_g4","Ey distribution",51,0,51);
   TH1F *hz_half_g4   = new TH1F("hz_half_g4","Ez distribution",25,0,25);
   TH3D *gan = new TH3D("gan","E distribution", 51,0,51,51,0,51,25,0,25);
   TH3D *g4 = new TH3D("g4","E distribution", 51,0,51,51,0,51,25,0,25);
   hx->Sumw2();
   hy->Sumw2();
   hz->Sumw2();
   hx_g4->Sumw2();
