...
import sys
sys.path.insert(0,"../analysis/utils")
...
def main():
   ...
   print(theta[:5])
   angles.append(a)
   PlotAngleMeasureAll(theta, angles, filename + 'relative_error_all')
   fig+=1
   PlotAngleMeasureAll(theta, angles, filename + 'error_all', relative=0)
   fig+=1
