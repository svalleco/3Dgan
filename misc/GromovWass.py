...
def main():
    ...
    plotsdir = 'results/angle_optimization_gw' # plot directory
    particle = "Ele" 
    scale = 1
    threshold = 0
    ang = 1
...
def analyse(g, read_data, save_data, gen_weights, datapath, sorted_path, optimizer, xscale=100, power=1, particle="Ele", thresh=1e-6, ang=1, concat=1, preproc=preproc, postproc=postproc):
   ...
   if read_data:
     ...
     var = gan.get_sorted_angle(data_files, energies, flag=False, num_events1=2000, num_events2=2000, thresh=thresh)
