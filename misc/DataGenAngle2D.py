...
def main():
   ...
   plotsdir = 'results/new_genplots_compare_bins_powp85_scaled' # name of folder to save results
   ...
   var = gan.get_sorted_angle(datafiles[25:], energies, True, num_events1, num_events2, angtype=angtype, thresh=thresh) # returning a dict with sorted data.
