...
def main():
   ...
   plot_ecal_flatten_hist_bins([x/scale], bins, outfile, y, labels, logy=0, norm=2, p=p)
   plot_ecal_flatten_hist_bins([x/scale], bins, outfile + '_log', y, labels, logy=1, norm=2, p=p)
