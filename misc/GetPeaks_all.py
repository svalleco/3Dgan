...
def main():
  ...
  plotsdir = 'results/peaks2_gan_training_all_ep16_seed1' # dir for results
  ...
  gen_weight1= "../weights/3dgan_weights_gan_training_all/params_generator_epoch_016.hdf5" # weights for generator
  g.load_weights(gen_weight1) # load weights
  sorted_data = gan.get_sorted_angle(data_files[25:60], energies, num_events1=10000, num_events2=50000, thresh=thresh) # load data in a dict
  sigma = 1
  peak_threshold=0.3
  # for each energy bin
  plist_g4=[]
