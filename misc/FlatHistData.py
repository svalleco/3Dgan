...
def main():
   ...
   genweight = "/nfshome/gkhattak/3Dgan/weights/3Dweights_100/params_generator_epoch_001.hdf5"
   ...
   numdata = 1000
   scale=100
   outdir = 'results/var_scale100_ep1'
   ...
   """
   labels = ['G4', 'GAN raw(scale 100)', 'GAN/100'] #'GAN var raw', 'GAN var (sqrt)', 'GAN fixed raw', 'GAN fixed scaled'] 
   ...
   plot_ecal_flatten_hist([x, x_gen1, x_gen2], outfile + '_log', y, labels, logy=1, norm=2)
